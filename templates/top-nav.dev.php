...
<div class="row-fluid topnav" style="background:#FFF">
	<div class="span4" id="topnav-logo">
...
<div class="span5">&nbsp;</div>
<div class="span3" id="topnav-help-cart">
	<div class="row-fluid">
		<div style="margin-right:10px;" class="top-nav-help-log span3">
			<?php
				if($memberAccess){
			?>
		...
		<?php
			if(!$memberAccess){
		?>
		<div class="span12" style="color:#FFFFFF; font-size:14px" align="right">
		...
		<a href="<?=$_SESSION["page"]["home_url"]?>account/" style="color:#FFC120" class="topNavLinkAcc">
			<div style="color:#FFC120; overflow:hidden;" class="span8">Hello, <?php echo($_SESSION['account']['refName']) ?><br />
...
<div style="width:100%; height:40px; z-index:50; position:absolute;" class="row-fluid appending-topnav visible-desktop">

	<a href="<?=$_SESSION["page"]["home_url"]?>wedding-registry/"><div class="span3" id="registryMenuWedding" style="width:20%">
		<img src="<?=$_SESSION["page"]["home_url"]?>img/icons/wedding-rings.png"/>
		&nbsp;&nbsp;Wedding Gift Registry
	</div></a>
	<a href="<?=$_SESSION["page"]["home_url"]?>baby-shower-registry/"><div class="span3" id="registryMenuBaby">
		<img src="<?=$_SESSION["page"]["home_url"]?>img/icons/baby-cart.png"/>
		&nbsp;&nbsp;Baby Shower Gift Registry</div></a>
	<a href="<?=$_SESSION["page"]["home_url"]?>graduation-registry/"><div class="span3" id="registryMenuGraduation">
		<img src="<?=$_SESSION["page"]["home_url"]?>img/icons/graduation.png"/>
		&nbsp;&nbsp;Graduation Gift Registry</div></a>
	<a href="javascript:void()"><div class="span2" id="registryMenuOther" style="width:10%">
		<img src="<?=$_SESSION["page"]["home_url"]?>img/icons/gift.png"/>
		&nbsp;&nbsp;Other</div></a>
        
     <!--search for a registry-->
	<div class="span2" id="search_registry">
...
<div class="row-fluid visible-phone registry-list-container" style="padding:10px; border:solid thin #000000; width:auto">
	<div class="span12 heading"><h4>Registry List&nbsp;&nbsp;<img src="<?=$_SESSION["page"]["home_url"]?>img/down-32.png" /></h4></div>
	<input type="hidden" value="0" class="toggleValue" />
	<div class="span12 row-fluid registry-list" style="display:none">
		<div class="span12" style="padding:5px 3px">
