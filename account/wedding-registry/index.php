    ...
    <body>
        ...
        <div class="body-content account-page row" style="margin-top:100px;">
            ...
            <div class="large-9 columns lowerContent">
                <br />
                <div class="row">
                    <div class="large-12 columns row" style="height:130px; background:#88C4FF">
...
?>
                    <form id="frmRegistry" method="post" enctype="multipart/form-data" action="<?= $FormSubmitTo ?>">
                        ...
                        <div class="large-12 columns row">
                            <div class="large-4 columns row" style="padding-left:20px">
                        ...
                        <div class="large-12 columns row dateContainer" style="margin-top:3%">
...
<?php echo(($FormData[6] != '') ? '<div class="inline-heading">(' . $FormData[6] . ')</div>' : '') ?>
                        ...
                        <div class="large-9 columns row photoContainer" style="margin-top:5%">
                            <div class="large-2 columns">
